...
const Login: React.FC = () => {
    ...
    const sendOTP = () => {
        ...
        axios.get(`/api/login/send-code`, {
            ...
            setLoading(false)
            toast.error("Erreur lors de l'envoie de l'OTP. Veuillez reesayer plus tard.")
        })
    }
    return (
        <div className='h-[100vh] flex flex-col justify-between'>
            <div className='w-full flex flex-col items-center'>
                ...
                <p className='text-sm opacity-75 -mt-4'>Affichez le BeReal de vos amis sans en publier un.</p>
            </div>
            <div className="flex items-center flex-col -mt-20">
                <h1 className="pb-6 text-xl font-bold">Numéro de téléphone :</h1>
                <PhoneInput
                    international
                    defaultCountry="FR"
                    value={phone}
