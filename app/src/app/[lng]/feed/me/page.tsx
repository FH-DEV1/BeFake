...
import { FeedType, UserPosts } from '@/components/Types'
            ...
            if (updatedFeed.friendsPosts) {
              ...
              if (postIndex !== -1) {
                  ...
                  if (post) {
                    ...
                    post.comments.sort((a: any, b: any) => new Date(b.postedAt).getTime() - new Date(a.postedAt).getTime());
        ...
        <div className="flex flex-col h-[100vh]">
            <div className='flex flex-row mt-5 mx-5 justify-between items-center'>
                ...
                <div className='flex flex-col justify-center items-center'>
                    <h1 className='text-xl'>{t("MyBeReal")}</h1>
                ...
                <div className='' onClick={() => router.push(`/${params.lng}/profile/me`)}>
