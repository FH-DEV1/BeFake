        ...
        <div>
            <div className="relative">
                ...
                <div className="absolute z-20 flex-col ml-2 bottom-2">
                    ...
                    <p className="-mt-2 text-lg opacity-60">{t("FriendedAt", {time: formatDate(Info?.data.relationship.friendedAt ? Info?.data.relationship.friendedAt : "", params.lng)})}</p>
                </div>
                <div className="absolute -bottom-[1px] w-full h-48 bg-gradient-to-t from-black to-transparent"></div>
            </div>
            <p className="text-3xl mt-6 ml-2 font-semibold">{t("Pins")}</p>
            ...
            <p className="text-3xl mt-6 ml-2 font-semibold">{t("CommonFriends", {number: Info?.data.relationship.commonFriends.sample.length})}</p>
