        ...
        <div className="flex flex-col justify-between items-center mt-[0.5vh] h-[99.5vh]">
            <div className="flex flex-col items-center">
                ...
                <div className={loading ? "hidden" : "flex flex-col items-center"}>
                    ...
                    <div onClick={() => toast.warn("Changer les RealMojis n'est pas disponible pour l'instant")} className="bg-zinc-900 rounded-xl py-3 border-2 border-zinc-700 w-[98vw] flex flex-col justify-center">
                        ...
                        <p className="mt-2 w-full text-center">Changer les RealMojis</p>
                    </div>
                            ...
                            <React.Fragment key={index}>
                                {MyInfo?.pinnedMemories && MyInfo.pinnedMemories[index] ? (
                                    ...
                                    <div
                                        ...
                                        onClick={() =>
                                            toast.warning("Epingler des memories n'est pas disponible pour l'instant")
                                        }
                                    >
                    ...
                    <button onClick={() => toast.warn("Memories indisponible pour le moment")} className="button mt-7">Memories</button>
                </div>
            </div>
            <p className={`text-xs mb-5 ${loading ? "hidden" : ""}`}>Actif depuis le {UTCtoParisDate(MyInfo?.data.createdAt ? MyInfo.data.createdAt : "")}</p>
      </div>
    )
};
