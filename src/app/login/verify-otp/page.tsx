...
const OTPValidate: React.FC = () => {
    ...
    const validateOTP = () => {
        ...
        fetch(`/api/login/verify-otp`, requestOptions)
                ...
                if (parsedResult.token) {
                    if (typeof window !== "undefined") {
                        ...
                        localStorage.setItem('token', JSON.stringify({
                            ...
                            token_expiration: parsedResult.expiration,
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center flex-col h-[90vh]">
                ...
                <button onClick={validateOTP} className={`${loading ? "hidden" : "block"} mt-6 py-1 px-3 rounded-md bg-zinc-900 border-2 border-zinc-700`}>valider</button>
